...
/**
 * Interface for implementing a logger for the results of health check runs.
 *
 ...
 */
public interface HealthCheckLogger {
    void logHealthCheckResult(HealthCheckDto dto);
}
