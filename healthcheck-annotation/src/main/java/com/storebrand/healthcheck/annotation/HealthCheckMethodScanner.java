...
/**
 * Interface used for scanning for methods annotated with {@link HealthCheck}.
 *
 ...
 */
public interface HealthCheckMethodScanner {
    /**
     * @return a set of {@link Method} that are annotated with {@link HealthCheck}.
     */
    Set<Method> getHealthCheckAnnotatedMethods();
}
